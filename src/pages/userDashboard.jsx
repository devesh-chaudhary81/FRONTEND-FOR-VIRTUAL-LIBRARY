...
const UserDashboard = () => {
  ...
  <h3 className="text-xl font-bold mb-6 text-blue-950 drop-shadow-[0_0_4px_#00ffff]">
    📘 Favourite Books
  </h3>
  ...
  <div className="flex flex-col gap-3">
    {favourites.map(book => (
      <a
        key={book._id}
        href={`/read/${book._id}`}
        className="px-4 py-2 rounded-lg bg-blue-900 w-[300px] text-white hover:bg-cyan-600 transition-all shadow-md drop-shadow-[0_0_4px_#00ffff] hover:scale-[1.02] text-left"
      >
        {book.title}
      </a>
    ))}
