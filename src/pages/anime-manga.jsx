    ...
    <div className="flex flex-col items-center min-h-screen bg-gradient-to-br from-[#01000d] via-[#08062f] to-[#0c053e] font-['Poppins'] px-6 py-10">
      ...
      <div className="flex flex-wrap justify-center items-center gap-6">
        {categories.map((card, index) => (
          <div
            key={index}
             onClick={() => handleCardClick(card.title+" anime")}
            className="cursor-pointer w-64 bg-white rounded-2xl overflow-hidden shadow-lg transform hover:scale-[1.05] hover:shadow-[0_30px_60px_rgb(50,49,49),_0_0_20px_rgb(227,221,247)] transition-all duration-500 animate-fadeUp"
