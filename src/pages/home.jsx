      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 font-[Inter] text-[#D1D9FF] min-h-screen">
        ...
        <header className="top-0 z-50 py-4">
          <div className="flex justify-between items-center">
            ...
            />
            <nav className="flex gap-20  ml-12">
              <Link
                to="/"
        ...
        <section className="text-center py-12">
          ...
          <p className="mt-6 text-white font-semibold text-lg max-w-xl mx-auto">
        ...
        <section className="mt-40 py-16">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-10">
            <div className="text-center max-w-md">
              ...
              <button className="mt-6 bg-[#4A69E2] text-white px-6 py-3 rounded-full font-bold hover:bg-[#3B5BDB] transition">
                <Link to="/categories" className="text-white no-underline">
                  Explore More
                </Link>
              </button>
            </div>
              ...
              >
                <div className="p-1 bg-[#10152B] rounded-lg">
                  <img
                    src={url}
                    alt="Library content"
                    className="w-[400px] h-80 object-cover rounded-md"
                  />
                </div>
              </div>
            ))}
